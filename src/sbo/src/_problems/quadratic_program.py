...
class QuadraticProgram:
    ...
    def export_as_lp_string(self) -> str:
        ...
        """
        # pylint: disable=cyclic-import
        from .._translators.docplex_mp import to_docplex_mp
    ...
    def read_from_lp_file(self, filename: str) -> None:
        ...
        # pylint: disable=cyclic-import
        from .._translators.docplex_mp import from_docplex_mp
    ...
    def to_ising(self) -> Tuple[SparsePauliOp, float]:
        ...
        """
        # pylint: disable=cyclic-import
        from .._translators.ising import to_ising
    ...
    def from_ising(
        ...
        """
        # pylint: disable=cyclic-import
        from .._translators.ising import from_ising
