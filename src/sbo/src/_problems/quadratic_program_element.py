...
from .. import _problems  # pylint: disable=cyclic-import


class QuadraticProgramElement:
    """Interface class for all objects that have a parent QuadraticProgram."""

    def __init__(self, quadratic_program: "_problems.QuadraticProgram") -> None:
    ...
    @property
    def quadratic_program(self) -> "_problems.QuadraticProgram":
    ...
    def quadratic_program(self, quadratic_program: "_problems.QuadraticProgram") -> None:
